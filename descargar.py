...
import descargar_imagen2
import PDF_conversor

def capAnz(url, nombre, path):
    ...
    descargar_imagen2.descargar_imagen(imagenes, "./temp")
    ...
    PDF_conversor.convertir_imagenes_a_pdf(imagenes, nombre)

    if os.path.exists(path):
        os.rename(nombre, os.path.join(path, nombre))
